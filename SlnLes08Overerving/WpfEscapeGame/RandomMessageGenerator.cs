...
namespace WpfEscapeGame
{
    static class RandomMessageGenerator
    {
        ...
        public static string GetRandomMessage(MainWindow.MessageType t)
        {
            switch (t)
            {
                case MainWindow.MessageType.NotWorking: return NotWorking[Random.Next(0, NotWorking.Length)];
                case MainWindow.MessageType.NotPickupable: return NotPickupable[Random.Next(0, NotPickupable.Length)];
                case MainWindow.MessageType.Dropped: return Dropped[Random.Next(0, Dropped.Length)];
