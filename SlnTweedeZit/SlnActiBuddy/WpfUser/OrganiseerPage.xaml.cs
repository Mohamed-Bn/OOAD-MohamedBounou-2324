...
{
    /// <summary>
    /// Interaction logic for OrganiseerPage.xaml
    /// </summary>
    public partial class OrganiseerPage : Page
    {
        ...
        public OrganiseerPage()
        {
            ...
            try
            {
                allActiviteiten = Activiteit.GetActiviteitenByPersoonId(persoon.Id);
            }
            catch (Exception ex)
            {
        ...
        {
            // eerst cast naar button, dan de tag eruithalen, en casten naar activiteit
        ...
        {
            NavigationService.Navigate(new ActiviteitAanmakenPage());
        }
    }
}
